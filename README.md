...
we are doing 1st one by using <b>adaptive thresholding technique threshold</b>  value is the mean of the neighborhood pixel values area minus the constant C. C is the constant subtracted from the weighted sum of neighborhood pixels.
